...
# Run ldsc analysis for level 1 annotations.
...
snakemake --use-conda -j -s /project/cphg-millerlab/Jose/CELLECT/cellect-ldsc.snakefile --configfile cellect_LDSC_config_multi_GWAS.yml
