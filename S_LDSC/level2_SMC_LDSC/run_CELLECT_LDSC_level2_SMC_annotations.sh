...
# Run LDSC analysis for level 2 SMC annotations.
...
snakemake --use-conda -j -s /project/cphg-millerlab/Jose/CELLECT/cellect-ldsc.snakefile --configfile cellect_LDSC_config_SMC_peri_fibro_multi_GWAS.yml
