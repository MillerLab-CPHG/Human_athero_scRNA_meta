...
--sumstats /project/cphg-millerlab/Jose/GWAS_summary_stats/GWAS_BMI/body_BMIz.sumstats.gz \
--merge-alleles /project/cphg-millerlab/Jose/CELLECT/data/ldsc/w_hm3.snplist \
--out /project/cphg-millerlab/Jose/human_scRNA_meta_analysis/CELLECT_analyses/munged_GWAS_summary_stats/BMI_GWAS/munged_UKBB_BMI \
--n-value 457824 \
--keep-pval \
--p PVAL \
--chunksize 500000
