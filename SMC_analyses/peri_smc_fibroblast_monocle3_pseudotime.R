...
# # Run branching analysis for fibromyocytes and fibrochondrocytes
# fibromyo_fibrochondro_cds = choose_cells(cds_ordered)
# fibro_cds_pr_test_res = monocle3::graph_test(fibromyo_fibrochondro_cds, 
#                                              neighbor_graph = "principal_graph", 
#                                              cores = 4)
# saveRDS(fibro_cds_pr_test_res, "~/Desktop/human_athero_scRNA_meta-analysis/rds_objects/monocle_objects/fibromyo_fibrochondro_branch_monocle3_cds_v3_graph_test.rds")
# 
# fibro_pr_deg_ids = row.names(subset(fibro_cds_pr_test_res, q_value < 0.05))
# fibro_gene_module_df = find_gene_modules(fibromyo_fibrochondro_cds[fibro_pr_deg_ids, ], resolution=0.001)
# 
# fibro_agg_mat = aggregate_gene_expression(fibromyo_fibrochondro_cds, fibro_gene_module_df)
# module_dendro = hclust(dist(fibro_agg_mat))
# fibro_gene_module_df$module = factor(fibro_gene_module_df$module, 
#                                 levels = row.names(fibro_agg_mat)[module_dendro$order])
# 
# 
# plot_cells(fibromyo_fibrochondro_cds,
#            genes=fibro_gene_module_df,
#            label_cell_groups=FALSE,
#            show_trajectory_graph=FALSE)
...
smc_fibrochondro_genes3 = c("CNN1", "COL1A2", "IBSP", "CRTAC1", "COMP", "MMP2")
...
ggsave("~/Desktop/human_athero_scRNA_meta-analysis/manuscript_figures/Figure6/Fig6c_SMC_fibromyo_markers_pseudotime.pdf",
...
fibrochondro_genes_pseudotime = plot_expression_on_pseudotime(cds_ordered = cds_ordered_v2, 
                                                          genes = smc_fibrochondro_genes3, 
                                                          cell_annotations = cells_types_of_interest2,
                                                          facet_wrap_plot = TRUE)

ggsave("~/Desktop/human_athero_scRNA_meta-analysis/manuscript_figures/Figure6/Fig6c_SMC_fibrochondro_markers_pseudotime.pdf",
