...
# Run MAGMA analysis for level 1 annotations.
...
snakemake --use-conda -j -s /project/cphg-millerlab/Jose/CELLECT/cellect-magma.snakefile --configfile cellect_MAGMA_config_multi_GWAS.yml
